...
func TestHelloWorld(t *testing.T) {
	...
	b.Resolvers("Query", (*helloWorldRoot)(nil), map[string]interface{}{
		"hello1": func(_ *helloWorldRoot) string {
			return "Hello world!"
		},

		"hello2": func(_ *helloWorldRoot, ctx context.Context) (string, error) {
